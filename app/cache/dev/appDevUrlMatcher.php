...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // ppe_hopital_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ppe_hopital_homepage')), array (  '_controller' => 'PPE\\HopitalBundle\\Controller\\DefaultController::indexAction',));
        }

        // ppe_hopital_accueil
        if ($pathinfo === '/accueil') {
            return array (  '_controller' => 'PPE\\HopitalBundle\\Controller\\DefaultController::accueilAction',  '_route' => 'ppe_hopital_accueil',);
        }
